...
#                                                           											#
#       				Conversor de valor numérico para extenso            							#
#																										#
#								 exemplo de como utilizar												#		
#						     echo Monetary::numberToExt(3000100.70);									#
#           o exemplo acima ira imprimir: três milhões, cem reais e setenta centavos					#
#	     	No valor do cheque não se usa "," e se usa "." antes do valor dos centavos			     	#
#																										#	
#########################################################################################################
